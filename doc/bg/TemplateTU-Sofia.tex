...
\begin{center}
    ...
    {\fontsize{20}{24}\selectfont\bfseries ПРОЕКТИРАНЕ И РАЗРАБОТВАНЕ НА БИБЛИОТЕКА НА С++, ПОДПОМАГАЩА СЪЗДАВАНЕТО НА УЕБ ПРИЛОЖЕНИЯ\par}
