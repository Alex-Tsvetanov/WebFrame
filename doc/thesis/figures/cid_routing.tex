...
\begin{tikzpicture}[
    ...
    % Локално връщаме note към чист текст: глобалният стил в preamble.tex я прави
    % запълнена пунктирана кутия с голямо поле, което покрива съседите.
...
\node[lbl, align=center] at (9.25,-5.9)
