...
\node[note] at (4.875,4.62) {протоколни слоеве};
...
\node[note, text width=12.8cm, anchor=north west] at (-1.525,-1.05)
...
\node[note, text width=12.8cm, anchor=north west] at (-1.525,-2.35)
