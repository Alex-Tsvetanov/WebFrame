...
namespace coroute {
	...
	void WebViewRenderer::validate_templates(const std::vector<ViewTemplates>& templates) {
	...
	Task<Response> WebViewRenderer::render(std::string_view template_id, const ViewResultAny& view_result) {
