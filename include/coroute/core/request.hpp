...
namespace coroute
{
	...
	public:
		...
		void set_route_params(std::vector<std::string> params) { route_params_ = std::move(params); }

		const std::vector<std::string>& route_params() const noexcept { return route_params_; }
