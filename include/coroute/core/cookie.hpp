...
namespace coroute {
	...
	void delete_cookie(Response& resp, std::string_view name, std::string_view path = "/",
	...
	inline CookieJar cookies(const Request& req) { return CookieJar::from_request(req); }
